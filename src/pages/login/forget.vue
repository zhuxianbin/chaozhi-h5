<template>
  <div class="page">
    ...
    <div class="t-lg t-center mb-10">找回您的账号</div>
    ...
    <van-row gutter="10" class="mb-20">
      ...
      <van-col span="16"><van-button @click='submitForm' :block="true" type="danger" size="large" :disabled="!isChecked">提 交</van-button></van-col>
    </van-row>
    <mt-popup
      v-model="popups.show"
...
import { userReset, getPhoneCaptcha } from "@/utils/api";
export default {
  name: "register",
  components: {
    [Field.name]: Field,
